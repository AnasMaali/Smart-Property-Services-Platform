...
- Total tables: 85 (includes BLUE V1 Phase 11 Service Contract Stripe Billing: `service_contract_billing_statuses`, `service_contract_billings`, `service_contract_billing_webhook_events` - see `phase11_contract_billing_migration.sql`; and BLUE V1 Phase A1 Admin Authorization Foundation: `admin_permissions`, `admin_role_permissions` - see `phase15_admin_permission_foundation_migration.sql`)
