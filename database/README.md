...
`blue_v1_schema.sql` already contains the final, current structure - including every phase's changes, up to and including BLUE V1 Phase B24 - so a fresh install never needs to run any of the numbered `phaseNN_*.sql` migration files individually.
