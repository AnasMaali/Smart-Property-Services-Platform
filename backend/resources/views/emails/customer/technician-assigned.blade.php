<x-emails.layout :heading="'Technician Assigned to Your Booking'">
<p>Hello {{ $fields['customer_name'] }},</p>
<p>A technician has been assigned to your upcoming booking.</p>
...
<tr><td style="padding:4px 0; color:#64748b;">Technician</td><td style="padding:4px 0;">{{ $fields['technician_name'] }}</td></tr>
