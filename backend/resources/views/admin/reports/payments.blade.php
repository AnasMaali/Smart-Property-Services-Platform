...
@section('title', 'Payment Report — BLUE Admin')
@section('page-title', 'Payment Report')

@section('content')

<div data-report-page="payments" class="space-y-6">

    <div class="print-only mb-4">
        <h2 class="text-lg font-bold">BLUE — Payment Report</h2>
        <p data-print-range class="text-sm text-slate-600"></p>
    </div>

    <div class="no-print">
        <h2 class="text-lg font-semibold text-slate-950">Payment Report</h2>
        <p class="mt-1 text-sm text-slate-500">Successful, failed and pending online payment activity</p>
    </div>
    ...
    <div data-report-empty class="hidden rounded-2xl border border-slate-200 bg-white p-10 text-center text-sm text-slate-500">No payments match these filters.</div>
    ...
    <div data-report-content style="display: none;" class="flex flex-col gap-6">
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <p data-field="total_payments" class="mt-2 text-2xl font-semibold text-slate-950"></p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                <p class="text-xs font-medium uppercase tracking-wide text-slate-500">Successful</p>
                <p data-field="successful_count" class="mt-2 text-2xl font-semibold text-emerald-600"></p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
