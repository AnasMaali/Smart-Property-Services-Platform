...
class NoOperationalEndpointsExposedTest extends TestCase
{
    ...
    public function test_only_the_expected_admin_routes_exist(): void
    {
        ...
        $this->assertSame([
            ...
            'api/v1/admin/bookings/{booking}/cancel',
            'api/v1/admin/bookings/{booking}/cancellation-preview',
            'api/v1/admin/bookings/{booking}/collect-on-site-payment',
            'api/v1/admin/bookings/{booking}/completion-report',
            ...
            'api/v1/admin/pricing-schemes/{pricingScheme}/preview',
            'api/v1/admin/pricing-schemes/{pricingScheme}/publish',
            'api/v1/admin/pricing-schemes/{pricingScheme}/retire',
            ...
            'api/v1/admin/service-checkpoint-action-types',
            'api/v1/admin/service-checkpoint-groups/{group}',
            'api/v1/admin/service-checkpoint-groups/{group}/activate',
            'api/v1/admin/service-checkpoint-groups/{group}/checkpoints',
            'api/v1/admin/service-checkpoint-groups/{group}/deactivate',
            'api/v1/admin/service-checkpoints/{checkpoint}',
            'api/v1/admin/service-checkpoints/{checkpoint}/activate',
            'api/v1/admin/service-checkpoints/{checkpoint}/deactivate',
            'api/v1/admin/service-content-section-types',
            'api/v1/admin/service-content-sections/{section}',
            'api/v1/admin/service-content-sections/{section}/activate',
            'api/v1/admin/service-content-sections/{section}/deactivate',
            'api/v1/admin/service-media/{media}/activate',
            'api/v1/admin/service-media/{media}/deactivate',
            'api/v1/admin/service-option-choice-attribute-types',
            'api/v1/admin/service-option-choice-attributes/{attribute}',
            'api/v1/admin/service-option-choice-attributes/{attribute}/activate',
            'api/v1/admin/service-option-choice-attributes/{attribute}/deactivate',
            'api/v1/admin/service-option-choices/{choice}',
            'api/v1/admin/service-option-choices/{choice}/activate',
            'api/v1/admin/service-option-choices/{choice}/attributes',
            ...
            'api/v1/admin/services/{service}/capabilities',
            'api/v1/admin/services/{service}/catalog-policy',
            'api/v1/admin/services/{service}/category',
            'api/v1/admin/services/{service}/checkpoint-groups',
            ...
            'api/v1/admin/services/{service}/payment-methods',
            'api/v1/admin/services/{service}/pricing-preview',
            ...
            'api/v1/admin/support-requests/{supportRequest}/assign-admin',
            'api/v1/admin/support-requests/{supportRequest}/messages',
            'api/v1/admin/support-requests/{supportRequest}/status',
            'api/v1/admin/support-requests/{supportRequest}/unassign-admin',
