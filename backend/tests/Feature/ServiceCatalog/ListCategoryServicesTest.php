...
class ListCategoryServicesTest extends TestCase
{
    ...
    public function test_response_exposes_only_the_documented_public_field_set(): void
    {
        ...
        $this->assertSame(['uuid', 'code', 'slug', 'name', 'short_description', 'is_featured', 'estimated_duration_minutes', 'quantity', 'requires_prepayment', 'pricing', 'primary_image', 'pricing_preview'], array_keys($entry));
