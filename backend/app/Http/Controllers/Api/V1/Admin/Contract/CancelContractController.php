...
use App\Actions\Admin\Contract\AdminCancelContractAction;
...
{
    public function __invoke(ContractActionReasonRequest $request, AdminCancelContractAction $action, string $contract): JsonResponse
    {
        /** @var User $authUser */
