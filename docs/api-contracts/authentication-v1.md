...
- No SMS delivery integration exists yet. OTP codes are generated, hashed, and stored server-side, but are never returned by any endpoint and are never logged.
